 ...
 * Mỗi single/group floor đều có planImage + panaromas (hotspot có label tiếng Nhật)
 */
...
const buildingsData = [
  // 1. 外構 - ảnh 1 toàn cảnh aerial
  {
    ...
    videos: sampleVideos,
    panaromas: [
      { id: "ext-1", name: "新1号館外観(南西面)", code: "南西面", number: 1, thumbnail: "/images/pana1.jpg", url: "/images/pana1.jpg", mapPosition: { x: 42.5, y: 76.5, angle: 0 }, defaultView: { yaw: 0, pitch: 0 }, label: "新1号館外観(南西面)", hotspots: [{ id: "hs-ext1-2", yaw: 35, pitch: -2, tooltip: "Đến 外観2", targetPanaroma: "ext-2" }], images: [{ id: "ext-1-img2", title: "Góc ban ngày", thumbnail: "/images/pana2.jpg", url: "/images/pana2.jpg" }, { id: "ext-1-img3", title: "Góc ban đêm", thumbnail: "/images/pana3.jpg", url: "/images/pana3.jpg" }] },
  ...
  // 4. 新1号館 - group 6階 (Ảnh 3 là 5階)
  {
    ...
    floors: [
      ...
      },
      {
        ...
        panaromas: [
          { id: "5f-1", name: "5階教授室等廊下", code: "5F-1", number: 1, thumbnail: "/images/pana1.jpg", url: "/images/pana1.jpg", mapPosition: { x: 60, y: 32, angle: 90 }, defaultView: { yaw: 0, pitch: 0 }, label: "5階教授室等廊下", hotspots: [], images: [{ id: "5f-1-img2", title: "Góc 2", thumbnail: "/images/pana3.jpg", url: "/images/pana3.jpg" }, { id: "5f-1-img3", title: "Góc 3", thumbnail: "/images/pana4.jpg", url: "/images/pana4.jpg" }] },
